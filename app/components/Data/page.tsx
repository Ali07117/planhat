...
function Data() {
  return (
    ...
    >
      <SwiperSlide> */}
      <div className="card border border-[1px] border-[#FFFFFF1C] rounded-[16px]  h-[518px] bg-[linear-gradient(180deg,rgba(26,25,28,0)_0%,#1A191C_100%)]">
