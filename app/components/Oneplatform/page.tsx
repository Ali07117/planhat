...
function Oneplatform() {
  return (
    ...
    <div className='  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-[100px] one-platform-cards flex gap-[40px]'>
    {/* <Swiper
    ...
    > */}
      {/* <SwiperSlide> */}
      <div className="card border border-[1px] border-[#FFFFFF1C] rounded-[16px]   bg-[linear-gradient(180deg,rgba(26,25,28,0)_0%,#1A191C_100%)]">
        <div className='flex justify-end'>
        <img src="/assets/card1.svg" alt="" />
        </div>
        <div className='py-[34px] card-under px-[40px]'>
      ...
      {/* </SwiperSlide> */}
      {/* <SwiperSlide> */}
      <div className="card ggg border border-[1px] border-[#FFFFFF1C] rounded-[16px]   bg-[linear-gradient(180deg,rgba(26,25,28,0)_0%,#1A191C_100%)]">
      <div className='flex justify-center'>
